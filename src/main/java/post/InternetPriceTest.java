...
public class InternetPriceTest {
    ...
    public void inputSpecialCharacters() {
        try {
            driver.findElement(By.id("price_internet")).sendKeys("&^&$$");
            driver.findElement(By.className("btn-click")).click();
            Thread.sleep(3000);
            String expect = "Trường bạn nhập vào phải là số";
            String actual = driver.findElement(By.id("price_internet_error")).getText();
    ...
    public void inputString() {
        try {
            driver.findElement(By.id("price_internet")).sendKeys("abc");
            driver.findElement(By.className("btn-click")).click();
            Thread.sleep(3000);
            String expect = "Trường bạn nhập vào phải là số";
            String actual = driver.findElement(By.id("price_internet_error")).getText();
    ...
    public void inputNull() {
        try {
            driver.findElement(By.id("price_internet")).sendKeys(null);
            driver.findElement(By.className("btn-click")).click();
            Thread.sleep(3000);
            String expect = "Trường không được để trống";
            String actual = driver.findElement(By.id("price_internet_error")).getText();
