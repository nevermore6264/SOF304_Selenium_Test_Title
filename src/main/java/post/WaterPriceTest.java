...
public class WaterPriceTest {
    ...
    public void inputSpecialCharacters() {
        try {
            driver.findElement(By.id("price_water")).sendKeys("&^&$$");
            driver.findElement(By.className("btn-click")).click();
            Thread.sleep(3000);
            String expect = "Trường bạn nhập vào phải là số";
            String actual = driver.findElement(By.id("price_water_error")).getText();
    ...
    public void inputString() {
        try {
            driver.findElement(By.id("price_water")).sendKeys("abc");
            driver.findElement(By.className("btn-click")).click();
            Thread.sleep(3000);
            String expect = "Trường bạn nhập vào phải là số";
            String actual = driver.findElement(By.id("price_water_error")).getText();
    ...
    public void inputNull() {
        try {
            driver.findElement(By.id("price_water")).sendKeys(null);
            driver.findElement(By.className("btn-click")).click();
            Thread.sleep(3000);
            String expect = "Trường không được để trống";
            String actual = driver.findElement(By.id("price_water_error")).getText();
